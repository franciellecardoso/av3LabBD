package br.edu.fateczl.WebServiceSigaClient.util;
...
public class HTTPConn {
	public InputStream getJsonInputStream(String httpUrl, String urlComp) throws MalformedURLException, IOException {
	...
	public String getOp(String httpUrl, String urlComp, String urlComp2)
			throws MalformedURLException, IOException, ProtocolException {
		Charset charset = Charset.forName("UTF8");
		URL url = new URL(httpUrl + urlComp + urlComp2);
